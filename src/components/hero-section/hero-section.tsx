export default function HeroSection() {
  return (
    <section className="">
      <h1 className="text-7xl md:text-9xl lg:text-[192px] pt-[0.75em] font-bold tracking-wide text-main-sky pl-4 md:pl-[0.75em] mb-[-0.1em]">
        Hello &mdash;
      </h1>
      <div className="text-3xl md:text-5xl font-bold bg-main-sky text-white md:pr-[2em] ">
        <p className="p-[0.75em] pt-[1.5em] leading-relaxed md:max-w-6xl md:pl-[1em] lg:pl-[3em]">
          Welcome to our world. We&apos;re Tech Vibe,{" "}
          <span className="text-main-sky font-outline hover:text-white hover:font-outline-none">
